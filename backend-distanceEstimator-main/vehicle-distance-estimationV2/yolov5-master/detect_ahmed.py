                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or save_crop or view_img:  # Add bbox to image
                        ...
                        with open('results/data/data.csv', 'a') as csvFile:
                            distance_estimation(inf[0],data,r'D:\fcis\Last Year\Graduation Project\backend-distanceEstimator-main\vehicle-distance-estimationV2\distance-estimator\models\model@1535477330.h5',r'D:\fcis\Last Year\Graduation Project\backend-distanceEstimator-main\vehicle-distance-estimationV2\distance-estimator')
